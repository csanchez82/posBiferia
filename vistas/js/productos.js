    ...
    $(".btnEditarProducto").click(function() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                $('#editarIVA').val(respuesta["iva_id"]).trigger('change'); 
                $('#editarIEPS').val(respuesta["ieps_id"]).trigger('change'); 
                $('#editarMinimo').val(respuesta["minInventario"]);
                $('#editarMaximo').val(respuesta["maxInventario"]);
                $('#editarInventario').val(respuesta["inventario"]);
                ...
                $('#editarUnidad').val(respuesta["unidadMedida_id"]).trigger('change'); 
                $('#editarProdServ').val(respuesta["clave_id"]).trigger('change'); 
                ...
                $('#editarObligar').prop('checked', respuesta["obligar"] == '1');
            }
        });
    });
